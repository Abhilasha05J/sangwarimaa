...
// ─────────────────────────────────────────────────────────────────────────────
// Empty state — bot avatar + "How Can I Help You!"
// ─────────────────────────────────────────────────────────────────────────────
      ...
      child: Column(
        ...
        children: [
          Container(
            width: 150,
            height: 150,
            child: Image.asset('assets/icons/chatbotbg.png')
          ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Container(
            width: 32,
            height: 32, child: Image.asset('assets/icons/chatbotprofile.png')
          ),
          const SizedBox(width: AppSpacing.sm),
          Container(
            padding: const EdgeInsets.symmetric(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () => onSend(controller.text),
                    child: Icon(Icons.send_rounded, color: AppColors.hintText, size: 25),
                  ),
                ],
              ),
            ),
