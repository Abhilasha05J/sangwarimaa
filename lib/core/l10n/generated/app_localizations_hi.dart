...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get bpcr_transport_title =>
      'स्वास्थ्य संस्थान तक पहुँचने के लिए परिवहन की अग्रिम व्यवस्था';
  ...
  @override
  String get bpcr_facilities_found => 'आस-पास उपलब्ध स्वास्थ्य संस्थान';

  @override
  String get bpcr_tba_available_question =>
      'क्या पारंपरिक प्रसव सहायक (टीबीए) उपलब्ध है?';

  @override
  String get bpcr_saving_reminder_quote =>
      'प्रिय माँ, आज की छोटी बचत कल सुरक्षित प्रसव में मदद कर सकती है। इस सप्ताह प्रसव और आपातकालीन आवश्यकताओं के लिए थोड़ी बचत अलग रखें। क्या आपने इस सप्ताह अपनी गर्भावस्था बचत में कोई राशि जोड़ी है?';

  @override
  String get bpcr_self_saving_label => 'स्वयं की बचत';

  @override
  String get bpcr_family_saving_label => 'परिवार की बचत';

  @override
  String get bpcr_husband_label => 'पति';

  @override
  String get bpcr_mother_in_law_label => 'सास';

  @override
  String get bpcr_name_hint => 'नाम';

  @override
  String get bpcr_contact_hint => 'संपर्क नंबर';

  @override
  String get bpcr_relation_hint => 'गर्भवती महिला से संबंध';

  @override
  String get bpcr_community_support_question =>
      'यदि हाँ, तो किसके साथ — जैसे स्वयं सहायता समूह (SHG), सामुदायिक नेता (पंच/सरपंच/शिक्षक/पारंपरिक चिकित्सक/अन्य) का विवरण दें।';

  @override
  String get bpcr_blood_donor_reminder_quote =>
      'प्रिय परिवार, सुरक्षित प्रसव की तैयारी का एक महत्वपूर्ण भाग संभावित रक्तदाता की पहले से पहचान करना है। आवश्यकता पड़ने पर इससे समय की बचत होती है। क्या आपने प्रसव के लिए संभावित रक्तदाता की पहचान कर ली है? कृपया पहले से परिवार या परिचितों से चर्चा करें।';

  @override
  String get bpcr_self_blood_group_label => 'मेरा रक्त समूह';

  @override
  String get bpcr_blood_group_verified_note =>
      'अंतिम बार आपके द्वितीय तिमाही एएनसी जाँच के दौरान सत्यापित किया गया।';

  @override
  String get bpcr_emergency_hospital_label => 'आपातकालीन अस्पताल';

  @override
  String get bpcr_family_donors_label => 'पारिवारिक रक्तदाता';

  @override
  String get bpcr_add_family_member => '+ परिवार का सदस्य जोड़ें';

  @override
  String get bpcr_add_community_donors => '+ सामुदायिक रक्तदाता जोड़ें';

  @override
  String get bpcr_community_donors_label => 'सामुदायिक रक्तदाता';

  @override
  String get bpcr_transport_plan_subtitle =>
      'अपनी सुरक्षा के लिए पहले से तैयारी करें।';

  @override
  String get bpcr_delivery_place_question =>
      'आप प्रसव कहाँ कराने की योजना बना रही हैं?';

  @override
  String get bpcr_place_government => 'सरकारी अस्पताल';

  @override
  String get bpcr_place_private => 'निजी अस्पताल';

  @override
  String get bpcr_place_undecided => 'अभी तय नहीं किया है';

  @override
  String get bpcr_hospital_name_label => 'अस्पताल का नाम';

  @override
  String get bpcr_hospital_name_hint => 'अस्पताल का नाम दर्ज करें';

  @override
  String get bpcr_transport_options_label => 'परिवहन के विकल्प';

  @override
  String get bpcr_option_government_ambulance =>
      'सरकारी एम्बुलेंस — 102 / 108 पर कॉल करें';

  @override
  String get bpcr_shared_with_family_question =>
      'क्या यह जानकारी परिवार के साथ साझा की गई है?';

  @override
  String get bpcr_option_private_ambulance => 'निजी एम्बुलेंस';

  @override
  String get bpcr_provider_name_hint => 'सेवा प्रदाता का नाम';

  @override
  String get bpcr_option_own_vehicle => 'स्वयं का वाहन';

  @override
  String get bpcr_vehicle_car => 'कार';

  @override
  String get bpcr_vehicle_bike => 'बाइक';

  @override
  String get bpcr_vehicle_other => 'अन्य';

  @override
  String get bpcr_driver_name_hint => 'चालक का नाम';

  @override
  String get bpcr_driver_number_hint => 'चालक का संपर्क नंबर';

  @override
  String get bpcr_identify_birth_companion_label => 'जन्म साथी की पहचान करें';

  @override
  String get bpcr_companion_asha => 'आशा कार्यकर्ता';

  @override
  String get bpcr_companion_husband => 'पति';

  @override
  String get bpcr_companion_other_family => 'परिवार के अन्य सदस्य';
  ...
  @override
  String get bpcr_support_panch => 'पंच';

  @override
  String get bpcr_support_sarpanch => 'सरपंच';

  @override
  String get bpcr_support_healers => 'पारंपरिक चिकित्सक';

  @override
  String get bpcr_support_school_teachers => 'विद्यालय के शिक्षक';

  @override
  String get bpcr_support_other => 'अन्य';
